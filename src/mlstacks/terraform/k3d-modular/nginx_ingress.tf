...
module "nginx-ingress" {
  ...
  count = (var.enable_experiment_tracker_mlflow || var.enable_orchestrator_kubeflow || var.enable_orchestrator_tekton || var.enable_artifact_store) && (!var.enable_model_deployer_seldon && !var.enable_model_deployer_huggingface) ? 1 : 0
