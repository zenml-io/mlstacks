  ...
  content  = <<-ADD
    ...
    components:
      ...
      model_deployer:
        ...
        base_url: http://${data.kubernetes_service.kserve_ingress.status.0.load_balancer.0.ingress.0.hostname}:${data.kubernetes_service.kserve_ingress.spec.0.port.1.port}
